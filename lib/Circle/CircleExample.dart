...
class CircleExamplesApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopScope(child: Scaffold(appBar: AppBar(title: const Text('Circle Examples')), body: ListView(children: [_buildSectionCard(context, 'Real-life Applications', Icons.public, Colors.blue, () => Navigator.push(context, MaterialPageRoute(builder: (context) => RealLifeApplicationsScreen()))), _buildSectionCard(context, 'Basic Circle Formulas', Icons.calculate, Colors.green, () => Navigator.push(context, MaterialPageRoute(builder: (context) => BasicFormulasScreen()))), _buildSectionCard(context, 'Standard Form of Circle', Icons.functions, Colors.orange, () => Navigator.push(context, MaterialPageRoute(builder: (context) => StandardFormScreen()))), _buildSectionCard(context, 'Circle Equations', Icons.square_foot, Colors.purple, () => Navigator.push(context, MaterialPageRoute(builder: (context) => CircleEquationsScreen()))), _buildSectionCard(context, 'Distance & Midpoint Formulas', Icons.straighten, Colors.red, () => Navigator.push(context, MaterialPageRoute(builder: (context) => DistanceMidpointScreen()))), _buildSectionCard(context, 'Graphing Circles', Icons.graphic_eq, Colors.teal, () => Navigator.push(context, MaterialPageRoute(builder: (context) => GraphingCirclesScreen()))), _buildSectionCard(context, 'Real-world Problems', Icons.landscape, Colors.brown, () => Navigator.push(context, MaterialPageRoute(builder: (context) => RealWorldProblemsScreen())))])));
  }
