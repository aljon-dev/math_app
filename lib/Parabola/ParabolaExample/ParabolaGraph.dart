...
class ParabolaFromGraphScreen extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildGraphExample(context: context, problem: '1. Find the standard equation of this graph:', solution: ['Vertex at (3, 0)', 'Focus at (6, 0)', 'Endpoints at (6, ±6)', 'Opens to the right → (y - k)² = 4p(x - h)', '4p = 12 (length of latus rectum)', 'Equation: y² = 12(x - 3)'], graphImage: 'assets/parabola_graph5.jpg'),
              const SizedBox(height: 24),
              _buildGraphExample(context: context, problem: '2. Find the standard equation of this graph:', solution: ['Vertex at (2, 2)', 'Focus at (2, 0)', 'Endpoints at (0, -2) and (0, 6)', 'Opens downward → (x - h)² = -4p(y - k)', '4p = 8 (length of latus rectum)', 'Equation: (x - 2)² = -8(y - 2)'], graphImage: 'assets/parabola_graph4.jpg'),
            ],
          ),
        ),
      ),
  ...
  Widget _buildGraphExample({required BuildContext context, required String problem, required List<String> solution, String? graphImage}) {
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (graphImage != null) ...[const SizedBox(height: 8), _buildZoomableImage(context, graphImage)],
