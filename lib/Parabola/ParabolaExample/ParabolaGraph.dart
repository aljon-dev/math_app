    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildGraphExample(problem: '1. Find the standard equation of this graph:', solution: ['Vertex at (3, 0)', 'Focus at (6, 0)', 'Endpoints at (6, ±6)', 'Opens to the right → (y - k)² = 4p(x - h)', '4p = 12 (length of latus rectum)', 'Equation: y² = 12(x - 3)'], graphImage: 'assets/parabola_graph3.jpg'),
