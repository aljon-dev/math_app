...
class _FormulasSectionState extends State<FormulasParabolaSection> {
  ...
  final List<Map<String, dynamic>> parabolaSteps = [
    ...
    {'title': 'Right Opening Parabola (Vertex at Origin)', 'content': 'Standard form: y² = 4px\n• Vertex: (0,0)\n• Focus: (p, 0)\n• Directrix: x = -p\n• Axis: y = 0\n• Latus Rectum: length = |4p|, endpoints at (p, ±2p)', 'image': 'assets/images/right_origin.jpg', 'type': 'formula'},
    {'title': 'Left Opening Parabola (Vertex at Origin)', 'content': 'Standard form: y² = -4px\n• Vertex: (0,0)\n• Focus: (-p, 0)\n• Directrix: x = p\n• Axis: y = 0\n• Latus Rectum: length = |4p|, endpoints at (-p, ±2p)', 'image': 'assets/images/left_origin.jpg', 'type': 'formula'},
    {'title': 'Upward Opening (Vertex at (h, k))', 'content': 'Standard form: (x - h)² = 4p(y - k)\n• Vertex: (h, k)\n• Focus: (h, k + p)\n• Directrix: y = k - p\n• Axis: x = h\n• Latus Rectum: endpoints at (h ± 2p, k + p)', 'image': 'assets/images/upward_hk.jpg', 'type': 'formula'},
    {'title': 'Downward Opening (Vertex at (h, k))', 'content': 'Standard form: (x - h)² = -4p(y - k)\n• Vertex: (h, k)\n• Focus: (h, k - p)\n• Directrix: y = k + p\n• Axis: x = h\n• Latus Rectum: endpoints at (h ± 2p, k - p)', 'image': 'assets/images/downward_hk.jpg', 'type': 'formula'},
    {'title': 'Right Opening (Vertex at (h, k))', 'content': 'Standard form: (y - k)² = 4p(x - h)\n• Vertex: (h, k)\n• Focus: (h + p, k)\n• Directrix: x = h - p\n• Axis: y = k\n• Latus Rectum: endpoints at (h + p, k ± 2p)', 'image': 'assets/images/right_hk.jpg', 'type': 'formula'},
    {'title': 'Left Opening (Vertex at (h, k))', 'content': 'Standard form: (y - k)² = -4p(x - h)\n• Vertex: (h, k)\n• Focus: (h - p, k)\n• Directrix: x = h + p\n• Axis: y = k\n• Latus Rectum: endpoints at (h - p, k ± 2p)', 'image': 'assets/images/left_hk.jpg', 'type': 'formula'},
  ];
