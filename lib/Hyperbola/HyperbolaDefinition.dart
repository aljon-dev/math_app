...
class _DefinitionSectionState extends State<DefinitionHyperBolaSection> {
  ...
  Future<void> play() async {
    try {
      if (currentStep == 0) {
        ...
        await player.setAsset('assets/Audio/HyperbolaStep3.mp3');
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Playing', style: TextStyle(color: Colors.white)), backgroundColor: Colors.green));
  ...
  final List<Map<String, dynamic>> steps = [
    {'title': 'What is a Hyperbola?', 'content': 'A hyperbola is a type of conic section formed when a plane intersects both halves of a double right circular cone at an angle. This results in two open, mirror-image curves.', 'image': 'assets/images/Hyperbola3.jpg'},
    {'title': 'Focus, Directrix, and Eccentricity', 'content': 'Each branch of a hyperbola has a focus, and the distances to the foci define its shape. The eccentricity of a hyperbola is greater than 1, distinguishing it from ellipses and circles.', 'image': 'assets/images/Hyperbola2.jpg'},
