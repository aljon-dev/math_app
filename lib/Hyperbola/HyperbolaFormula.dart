...
class _FormulasHyperbolaSectionState extends State<FormulasHyperbolaSection> {
  ...
  final List<Map<String, dynamic>> steps = [
    {'title': 'General Equation of a Hyperbola', 'content': 'This is the general form used to represent a hyperbola in conic sections.', 'formula': r'Ax² - By² + Cx + Dy + E = 0', 'image': '', 'type': 'formula'},
    {'title': 'Eccentricity', 'content': 'Eccentricity defines how "stretched" a hyperbola is. It is always greater than 1.', 'formula': r'e = c / a', 'image': 'assets/images/eccentricity_hyperbola.jpg', 'type': 'formula'},

    {'title': 'Standard Form (Center at Origin, Horizontal)', 'content': 'The standard form of the equation of a hyperbola with center (0,0) and transverse axis on the x-axis.', 'formula': r'x² / a² - y² / b² = 1', 'image': 'assets/images/standard_horizontal_origin_hyperbola.jpg', 'type': 'formula', 'details': '• Transverse Axis Length = 2a\n• Vertices = (±a, 0)\n• Conjugate Axis Length = 2b\n• Co-Vertices = (0, ±b)\n• Foci = (±c, 0), where c² = a² + b²\n• Asymptotes = y = ±(b/a)x'},
    {'title': 'Standard Form (Center at Origin, Vertical)', 'content': 'The standard form of the equation of a hyperbola with center (0,0) and transverse axis on the y-axis.', 'formula': r'y² / a² - x² / b² = 1', 'image': 'assets/images/standard_vertical_origin_hyperbola.jpg', 'type': 'formula', 'details': '• Transverse Axis Length = 2a\n• Vertices = (0, ±a)\n• Conjugate Axis Length = 2b\n• Co-Vertices = (±b, 0)\n• Foci = (0, ±c), where c² = a² + b²\n• Asymptotes = y = ±(a/b)x'},
    {'title': 'Standard Form (Center at (h, k), Horizontal)', 'content': 'The standard form of the equation of a hyperbola with center (h,k) and transverse axis parallel to the x-axis.', 'formula': r'(x - h)² / a² - (y - k)² / b² = 1', 'image': 'assets/images/standard_horizontal_hk_hyperbola.jpg', 'type': 'formula', 'details': '• Transverse Axis Length = 2a\n• Vertices = (h ± a, k)\n• Conjugate Axis Length = 2b\n• Co-Vertices = (h, k ± b)\n• Foci = (h ± c, k), where c² = a² + b²\n• Asymptotes = y - k = ±(b/a)(x - h)'},
    {'title': 'Standard Form (Center at (h, k), Vertical)', 'content': 'The standard form of the equation of a hyperbola with center (h,k) and transverse axis parallel to the y-axis.', 'formula': r'(y - k)² / a² - (x - h)² / b² = 1', 'image': 'assets/images/standard_vertical_hk_hyperbola.jpg', 'type': 'formula', 'details': '• Transverse Axis Length = 2a\n• Vertices = (h, k ± a)\n• Conjugate Axis Length = 2b\n• Co-Vertices = (h ± b, k)\n• Foci = (h, k ± c), where c² = a² + b²\n• Asymptotes = y - k = ±(a/b)(x - h)'},
  ];
        ...
        endDrawer: Drawer(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(title: Text(steps[index]['title']), selected: index == currentStep, selectedTileColor: Colors.blue.withOpacity(0.1), onTap: () => _NavigateTo(index));
            },
          ),
        ),
        body: Column(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Image (if available)
                      if (currentStepData['image'] != '') ...[Center(child: Image.asset(currentStepData['image'], fit: BoxFit.contain, height: 300, width: double.infinity)), const SizedBox(height: 20)] else ...[Text('')],
