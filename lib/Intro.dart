          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  // Title
                  Row(children: [Icon(Icons.school, color: Colors.blue[600], size: 28), const SizedBox(width: 12), const Expanded(child: Text('What is Conic Section?', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black87)))]),
                  ...
                  Container(
                    padding: const EdgeInsets.all(16), decoration: BoxDecoration(
                      ...
                      child: const Text('A curve that is generated by intersecting a right circular cone with a plane is termed as ‘conic’.', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.black87, height: 1.5))),
